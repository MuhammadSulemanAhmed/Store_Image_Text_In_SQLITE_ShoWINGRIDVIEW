...
public class dataAdapter extends ArrayAdapter<TripModel> {
    Context context;
    ArrayList<TripModel> mcontact;


    public dataAdapter(Context context, ArrayList<TripModel> tripModel){
        super(context, R.layout.listcontacts, tripModel);
